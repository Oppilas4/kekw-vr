...
public class HS_VolumeSettings : MonoBehaviour
{
    ...
    private void Start()
    {
        _musicSlider.value = PlayerPrefs.GetFloat(HS_AudioManager.MUSIC_VOLUME_KEY, 1f);
        _musicSlider.value = PlayerPrefs.GetFloat(HS_AudioManager.SFX_VOLUME_KEY, 1f);
    }

    private void OnDisable()
    {
       PlayerPrefs.SetFloat(HS_AudioManager.MUSIC_VOLUME_KEY, _musicSlider.value);
       PlayerPrefs.SetFloat(HS_AudioManager.SFX_VOLUME_KEY, _SFXSlider.value);
    }
